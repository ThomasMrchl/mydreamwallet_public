...
if ($_SESSION['pseudo']!=null){
    ...
    if (isset($stockPrice) && !empty($stockPrice)) {
        ...
        if ($money >= $stockPrice){
            ...
            $sql_insert = "INSERT Into exchange (exchange.id_user,exchange.crypto,exchange.type,exchange.quantity,exchange.cost,exchange.date) VALUES ('".$user_id."','".$name."','buy',1,'".$stockPrice."','".$date."')";
